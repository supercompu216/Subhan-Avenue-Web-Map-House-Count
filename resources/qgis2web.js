...
map.getView().fit([7454718.463970, 3532387.236365, 7455033.467226, 3532572.521681], map.getSize());
    ...
    element: (() => {
        ...
        if (380 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = '(How to use Web Map)<br />Zoom in the Map and click on <br />1. Red Dot it will Indicates the Number of House <br />There are total 227 Houses (Start 1, End 227)<br />Plots are not counted.<br />Shops are not included.<br />2. Yellow Polygon Shape Indicates Mosques<br />3. Blue Polylines Indicates Roads with in Scheme<br />4. Red Boundry Indicates Boundry of Scheme<br />5. Pink Lines Indicates Starting & Ending (House) <br /><br />';
            }
